...
function previousChapter() {
  ...
  var ajaxRequest = new XMLHttpRequest();
  var apiRequest = "http://" + server + "/v0/previous?mode=chapter&ref=" + leadBook + "~" + leadChapter + "." + leadVerse;
  ajaxRequest.open("GET", apiRequest, true);
...
function nextChapter() {
  ...
  var ajaxRequest = new XMLHttpRequest();
  var apiRequest = "http://" + server + "/v0/next?mode=chapter&ref=" + leadBook + "~" + leadChapter + "." + leadVerse;
  ajaxRequest.open("GET", apiRequest, true);
